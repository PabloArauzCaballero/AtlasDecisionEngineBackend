...
description: Corre y evidencia todos los gates del backend Atlas (prisma validate, migrate, typecheck, build, test, e2e, smoke, OpenAPI) contra infraestructura real, y solo declara "listo" con salida real. Úsala antes de decir que un cambio funciona o antes de un release.
---
