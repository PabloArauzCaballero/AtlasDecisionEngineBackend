...
| --- | ---: | --- | ---: |
| [`artifacts`](artifacts.md) | 13 | AUDITOR, COMPLIANCE, FRAUD_ANALYST, OPERATIONS, QA_ANALYST, RISK_ANALYST | 11 |
| [`audit-query`](audit-query.md) | 6 | AUDITOR, COMPLIANCE, OPERATIONS, RISK_ANALYST | 7 |
...
| [`qa-lab`](qa-lab.md) | 6 | AUDITOR, COMPLIANCE, FRAUD_ANALYST, PLATFORM_ADMIN, QA_ANALYST, RISK_ANALYST | 13 |
| [`runtime`](runtime.md) | 3 | FRAUD_ANALYST, QA_ANALYST, RISK_ANALYST | 11 |
| [`security-review`](security-review.md) | 2 | — | 4 |
| [`seeding`](seeding.md) | 0 | — | 28 |
...
| [`views`](views.md) | 9 | — | 5 |
| [`workers`](workers.md) | 13 | AUDITOR, COMPLIANCE, FRAUD_ANALYST, OPERATIONS, QA_ANALYST, RISK_ANALYST | 100 |
