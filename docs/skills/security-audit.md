---
title: "Auditoría de seguridad — Atlas Decision Engine (backend)"
tags:
  - skills
  - entorno-asistido
---
<!-- GENERADO POR scripts/docs/generate-vault.mjs — NO EDITAR A MANO.
     Fuente: .claude/skills/security-audit/SKILL.md. Ejecute `yarn docs:vault` tras cambiarla. -->

# Auditoría de seguridad — Atlas Decision Engine (backend)

!!! abstract "Ficha de la skill"
    **Invocación:** `security-audit` · **Fuente canónica:** `.claude/skills/security-audit/SKILL.md`

    **Descripción registrada:** Revisión de seguridad enfocada del backend Atlas — RBAC real en backend, RLS por tenant en tablas nuevas, aislamiento de ejecución de código importado, cadena de auditoría append-only, y ausencia de secretos. Úsala al añadir endpoints, tablas o ejecución de código, o antes de un release.
