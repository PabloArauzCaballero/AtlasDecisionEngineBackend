 ...
 * PostgreSQL propio (`seed_atlas_decision`, en `atlas-postgres`), y este módulo dice cuál.
 *
...
export interface SeedSource {
  ...
  /** Host sin credenciales, para registrar a qué base se apuntó sin filtrar la contraseña. */
