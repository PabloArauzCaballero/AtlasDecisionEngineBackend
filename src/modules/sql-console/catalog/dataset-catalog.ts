  ...
  tables: [
    {
      ...
      columns: [
        id('ejecucion_id', 'Identificador de la ejecución. Une con pasos, motivos y errores.'),
        {
          name: 'peticion',
          kind: 'texto',
          description: 'Identificador de la petición del integrador.',
        },
        {
          name: 'correlacion',
          kind: 'texto',
          description: 'Correlación entre sistemas, si el integrador la mandó.',
        },
        ...
        {
          name: 'dominio_de_riesgo',
          kind: 'texto',
          description: 'Dominio de riesgo del artefacto.',
        },
        {
          name: 'tipo_de_decision',
          kind: 'texto',
          description: 'ORIGINATION, LIMIT_CHANGE, COLLECTION…',
        },
        ...
        {
          name: 'desenlace_de_negocio',
          kind: 'texto',
          description: 'Desenlace declarado por el artefacto.',
        },
        {
          name: 'duracion_ms',
          kind: 'entero',
          description: 'Cuánto tardó la decisión, en milisegundos.',
        },
        {
    ...
    },
    {
      ...
      columns: [
        ...
        { name: 'rama_tomada', kind: 'texto', description: 'Rama por la que salió la evaluación.' },
        {
          name: 'duracion_us',
          kind: 'entero',
          description: 'Duración del paso, en microsegundos.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      columns: [
        ...
        { name: 'tipo', kind: 'texto', description: 'Familia del error.' },
        {
          name: 'reintentable',
          kind: 'booleano',
          description: 'Si el motor lo considera transitorio.',
        },
      ],
    },
  ],
    ...
    },
    {
      ...
      columns: [
        ...
        { name: 'equipo_responsable', kind: 'texto', description: 'Equipo dueño de la variable.' },
        {
          name: 'es_sensible',
          kind: 'booleano',
          description: 'Bandera derivada de la sensibilidad.',
        },
        {
          name: 'activa',
          kind: 'booleano',
          description: 'Si sigue disponible para nuevos contratos.',
        },
      ],
    },
    {
      ...
      columns: [
        ...
        { name: 'severidad', kind: 'texto', description: 'Severidad.' },
        {
          name: 'es_accion_adversa',
          kind: 'booleano',
          description: 'Si es notificable como acción adversa.',
        },
        { name: 'activo', kind: 'booleano', description: 'Si sigue vigente.' },
        {
          name: 'mensaje_publico',
          kind: 'texto',
          description: 'Mensaje que se le comunica al solicitante.',
        },
      ],
    },
  ],
  ...
  tables: [
    ...
    },
    {
      ...
      columns: [
        ...
        {
          name: 'metodo_de_inferencia',
          kind: 'texto',
          description: 'Cómo se infirió, si no se observó directamente.',
        },
    ...
    },
    {
      ...
      columns: [
        ...
        { name: 'vence_en', kind: 'fecha', description: 'Cuándo debe estar observada.' },
        {
          name: 'observada_en',
          kind: 'fecha',
          description: 'Cuándo se observó. Nulo si sigue abierta.',
        },
        {
  ...
  tables: [
    {
      ...
      columns: [
        ...
        { name: 'veredicto', kind: 'texto', description: 'PASS, WARN, FAIL.' },
        {
          name: 'tamano_muestra',
          kind: 'entero',
          description: 'Observaciones sobre las que se midió.',
        },
    ...
    },
    {
      ...
      columns: [
        ...
        { name: 'metrica', kind: 'texto', description: 'Código de la métrica.' },
        {
          name: 'segmento',
          kind: 'texto',
          description: 'Segmento. Nulo cuando es la cartera entera.',
        },
    ...
    },
    {
      ...
      columns: [
        ...
        { name: 'desplegado_en', kind: 'fecha', description: 'Cuándo se desplegó.' },
        {
          name: 'es_reversion',
          kind: 'booleano',
          description: 'Si el despliegue revierte a otro anterior.',
        },
      ],
    },
  ],
